/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/app/wrangler.jsonc workers/app/worker-configuration.d.ts` (hash: 0500d646461219f0990b1037bc826b4c)
...
interface __BaseEnv_Env {
	...
	EMAIL_DELIVERY_CONFIG: {"mode":"allowlist","allowlist":[],"authFrom":"OpenSession <auth@updates.opensessionboard.com>","authReplyTo":"hello@opensessionboard.com"} | {"mode":"sink","allowlist":[],"authFrom":"OpenSession <auth@local.opensession.test>","authReplyTo":"hello@local.opensession.test"};
	...
	AGENDA_COORDINATOR: DurableObjectNamespace<import("./src/index").AgendaCoordinator>;
	BASE_AUTHORITY: DurableObjectNamespace<import("./src/index").BaseAuthority>;
	TASK_REMINDER_WORKFLOW: Workflow<Parameters<import("./src/index").TaskReminderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AgendaCoordinator" | "BaseAuthority";
	}
