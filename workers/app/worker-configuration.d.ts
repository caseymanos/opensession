/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/app/wrangler.jsonc workers/app/worker-configuration.d.ts` (hash: a36e899251ec3220aceec5cc8ee1aafa)
...
interface __BaseEnv_Env {
	...
	INTEGRATION_EXPORT_QUEUE: Queue;
	WORKER_VERSION: WorkerVersionMetadata;
	APP_ENV: "preview" | "production" | "local";
	AIRTABLE_BASE_ID: "app_CONFIGURE_PREVIEW" | "app_CONFIGURE_PRODUCTION" | "app_CONFIGURE_LOCAL";
	EMAIL_DELIVERY_CONFIG: {"mode":"allowlist","allowlist":[],"authFrom":"OpenSession <auth@preview.opensessionboard.com>","authReplyTo":"hello@opensessionboard.com"} | {"mode":"allowlist","allowlist":[],"authFrom":"OpenSession <auth@updates.opensessionboard.com>","authReplyTo":"hello@opensessionboard.com"} | {"mode":"sink","allowlist":[],"authFrom":"OpenSession <auth@local.opensession.test>","authReplyTo":"hello@local.opensession.test"};
	FEATURE_FLAGS: {"ai":false,"embeds":false,"email":false,"integrations":false,"webhooks":false,"writes":true} | {"ai":false,"embeds":false,"email":false,"integrations":false,"webhooks":false,"writes":false};
	TURNSTILE_HOSTNAMES: "preview.opensessionboard.com" | "opensessionboard.com,www.opensessionboard.com" | "localhost,127.0.0.1";
	TURNSTILE_SITE_KEY: "CONFIGURE_TURNSTILE_SITE_KEY" | "1x00000000000000000000AA";
	AIRTABLE_PAT: string;
	AUTH_HASH_PEPPER: string;
	RESEND_API_KEY: string;
	RESEND_WEBHOOK_SECRET: string;
	TURNSTILE_SECRET: string;
	BASE_AUTHORITY: DurableObjectNamespace<import("./src/index").BaseAuthority>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BaseAuthority";
	}
	interface PreviewEnv {
		...
		EMAIL_DELIVERY_CONFIG: {"mode":"allowlist","allowlist":[],"authFrom":"OpenSession <auth@preview.opensessionboard.com>","authReplyTo":"hello@opensessionboard.com"};
		FEATURE_FLAGS: {"ai":false,"embeds":false,"email":false,"integrations":false,"webhooks":false,"writes":true};
		TURNSTILE_HOSTNAMES: "preview.opensessionboard.com";
		TURNSTILE_SITE_KEY: "CONFIGURE_TURNSTILE_SITE_KEY";
		AIRTABLE_PAT: string;
		AUTH_HASH_PEPPER: string;
		RESEND_API_KEY: string;
		RESEND_WEBHOOK_SECRET: string;
	...
	interface ProductionEnv {
		...
		EMAIL_DELIVERY_CONFIG: {"mode":"allowlist","allowlist":[],"authFrom":"OpenSession <auth@updates.opensessionboard.com>","authReplyTo":"hello@opensessionboard.com"};
		FEATURE_FLAGS: {"ai":false,"embeds":false,"email":false,"integrations":false,"webhooks":false,"writes":false};
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "AIRTABLE_BASE_ID" | "EMAIL_DELIVERY_CONFIG" | "FEATURE_FLAGS" | "TURNSTILE_HOSTNAMES" | "TURNSTILE_SITE_KEY" | "AIRTABLE_PAT" | "AUTH_HASH_PEPPER" | "RESEND_API_KEY" | "RESEND_WEBHOOK_SECRET" | "TURNSTILE_SECRET">> {}
}
