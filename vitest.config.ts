  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "apps/web/src/integrations/{apiAccessRoute,apiKeyClient}.ts",
        "apps/web/src/readiness/readinessClient.ts",
        "packages/calendar/src/{canonical,invitation,render,time}.ts",
        "packages/contracts/src/{calendar,demo,index,portal,public-api,readiness,schedule,tasks}.ts",
        ...
        "workers/app/src/readiness/service.ts",
        "workers/app/src/portal/{brand,routes,service}.ts",
        "workers/app/src/public-api/{catalog,crypto,docs,http,key-service,openapi,rate-limit,repository,routes}.ts",
